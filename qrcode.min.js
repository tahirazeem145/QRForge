...
(function(root) {
  ...
  var QRCodeLib = {
    renderCanvas: function(canvas, text, options) {
      ...
      var ec = ecMap[options.errorCorrectionLevel] || 'M';

      // Type 0 = auto detect version 1 to 40
      var qr = qrcode(0, ec);
      qr.addData(text);
      qr.make();
      ...
      for (var r = 0; r < moduleCount; r++) {
        for (var c = 0; c < moduleCount; c++) {
          if (qr.isDark(r, c)) {
            ...
            var w = Math.ceil((c + margin + 1) * cellSize) - x;
            var h = Math.ceil((r + margin + 1) * cellSize) - y;
  ...
  if (typeof self !== 'undefined') {
    self.QRCodeLib = QRCodeLib;
  }
  if (typeof globalThis !== 'undefined') {
    globalThis.QRCodeLib = QRCodeLib;
  }
  root.QRCodeLib = QRCodeLib;
